...
Public Class frmQuanlySp
    ...
    Private Sub LoadData()
        ...
        dgvSanpham.DataSource = db.DefaultView
    End Sub
    Private Sub btnCapnhat_Click(sender As Object, e As EventArgs) Handles btnSửa.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim query As String = "insert into SANPHAM values(@MASP,@TENSP,@SOLUONG,@MALOAI) insert into LOAISANPHAM values(@MALOAI,@MASP,@TENLOAI)"
